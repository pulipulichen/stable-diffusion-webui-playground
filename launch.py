...
if __name__ == "__main__":
    prepare_environment()
    os.system(f"""sed -i -e "s/dict()))/dict())).cuda()/g" /content/drive/MyDrive/stable-diffusion-webui-colab/stable-diffusion-webui/repositories/stable-diffusion-stability-ai/ldm/util.py""")
    start()
